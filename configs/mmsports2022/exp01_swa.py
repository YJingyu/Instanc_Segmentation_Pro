_base_ = [
    '../_base_/datasets/mmsports2022_instance.py',
...
work_dir = '/lengyu.yb/logs/mmsports2022/exp01_swa'
only_swa_training = True

swa_training = True
swa_load_from = '/lengyu.yb/logs/mmsports2022/exp01/epoch_90_mms.pth'
