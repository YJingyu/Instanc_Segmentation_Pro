_base_ = [
    '../_base_/datasets/mmsports2022_instance2.py',
...
data = dict(samples_per_gpu=6)   # A100-80G
...
work_dir = '/lengyu.yb/logs/mmsports2022/exp07_swa'
only_swa_training = True

swa_training = True
swa_load_from = '/lengyu.yb/logs/mmsports2022/exp07/epoch_150_mms.pth'
